    ...
    <div class="row">
        <div class="col-md-6 col-md-offset-3">
            <div class="panel panel-default tttt">
                <div class="panel-heading panelheader">Add User</div>
                ...
                <form class = "" method = "post" action = "{{route('user.store')}}">
                  ...
                  <p>Last Name </p>
                  <input type= "text" class = "form-control" name="lastname" value = "" required><br>

                  <p>Position </p>
                  <input type= "text" class = "form-control" name="position" value = "" required><br>

                  <p>Email </p>
                    <input type= "text" class = "form-control" name="email" value = "" required><br>
                    <p>Role </p>
                      ...
                      <p>Week</p>
                        <input style="width: 200px;" type= "number" class = "form-control" name="week" value = "" required><br>
